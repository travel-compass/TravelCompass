...
public class Pagination {
	   ...
	   private int totalCount;        // 전체 게시글 수 listCount -> totalCount
	   
	   private int numOfRows = 10;    // 한 페이지 목록에 보여지는 게시글 수 limit -> numOfRows
	   ...
	   public Pagination(int totalCount, int pageNo, int numOfRows, int pageSize) {
	      this.totalCount = totalCount;
	      this.pageNo     = pageNo;
	...
	public String toString() {
		return "Pagination [pageNo=" + pageNo + ", totalCount=" + totalCount + ", numOfRows=" + numOfRows
